...
<div style="border: 1px solid #aaa; border-radius: 6px; padding: 12px; background: #020202ff;">
<b>Warning:</b><br><br>
Before using the pvmove command, back up the data that is stored on all LVs in the VG. An unexpected power loss during the operation might leave the VG in an inconsistent state, which might cause a loss of data on LVs.<br><br>
</div>
...
<div style="border: 1px solid #aaa; border-radius: 6px; padding: 12px; background: #020202ff;">
<b>Warning:</b><br><br>
The lvremove, vgremove, and pvremove commands are destructive, and unrecoverable operations. Use these commands only when you are sure that the LVM component is no longer needed or in use.<br><br>
</div>
